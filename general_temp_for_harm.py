...
def plot_content_type_totals2(data, harm):
    ...
    '["CONTENT_TYPE_AUDIO","CONTENT_TYPE_IMAGE","CONTENT_TYPE_TEXT","CONTENT_TYPE_VIDEO"]': 'AUDIO/IMAGE/TEXT/VIDEO',
    '["CONTENT_TYPE_VIDEO","CONTENT_TYPE_TEXT","CONTENT_TYPE_IMAGE"]': 'VIDEO/TEXT/IMAGE',
    '["CONTENT_TYPE_TEXT","CONTENT_TYPE_VIDEO","CONTENT_TYPE_IMAGE"]': 'TEXT/VIDEO/IMAGE',
    '["CONTENT_TYPE_VIDEO","CONTENT_TYPE_IMAGE","CONTENT_TYPE_TEXT"]': 'VIDEO/IMAGE/TEXT',
...
def plot_normalized_automation_status2(data, harm):
    ...
    # Rename the automated decision categories and handle unmapped values as 'Unknown'
